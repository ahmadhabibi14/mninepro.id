...
<div class="w-full px-6 my-14">
  <div class="flex flex-col gap-11">
    <h2 id="our-services" class="text-5xl text-center font-bold font-orbitron">
      Our Services
    </h2>
    <div class="flex flex-wrap gap-6 justify-center-safe items-center">
      {#each services as s}
      <div class="h-64 w-80 grid grid-rows-[70%_1fr] rounded-xl border border-slate-200 overflow-hidden bg-slate-100">
