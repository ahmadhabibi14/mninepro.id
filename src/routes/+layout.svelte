...
{#if $UNDER_CONSTRUCTION}
	<Head title="MNine Production | Under Construction" />

	<div
		class="bg-white text-slate-800 top-0 bottom-0 left-0 right-0 h-screen w-screen overflow-x-hidden"
	>
				...
				<div class="flex flex-col gap-5 justify-center items-center h-full w-full">
					...
					<div class="flex flex-col gap-2 justify-center items-center text-center">
						...
						<p class="md:text-lg text-base">
							Complete Event Equipment Rental Solutions by <a
								href="https://mninepro.id"
								class="italic underline">mninepro.id</a
							>
						</p>
					</div>
				</div>
